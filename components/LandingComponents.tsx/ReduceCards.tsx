...
const ReduceCards = () => {
  ...
  const onCardClick = (e: any) => {
    ...
    setCurIdx(e.currentTarget.dataset.idx);
  };
  return (
    <div>
      <div className="flex flex-row w-full mx-[10px]">
        <div role="button" data-idx="0" onClick={onCardClick} className="mx-[20px]">
          <ReduceCard
            isOpened={curIdx === "0"}
            width={660}
            height={300}
      ...
      <div role="button" data-idx="2" onClick={onCardClick} className="flex mx-[20px] mt-[40px]">
        <ReduceCard
          isOpened={curIdx === "2"}
          width={1400}
          height={300}
