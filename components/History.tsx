...
const History = ({year}:HistoryType) => {
  ...
  return (
    <div className = "relative  overflow-hidden rounded-lg shadow-lg cursor-pointe">
      {/* <BlackContainer /> */}
     ...
     <div className ={`absolute top-0 left-0 px-6 py-4  w-[100%]`}>
       <h4 className="mb-3 text-5xl font-semibold tracking-tight text-white flex w-[100%] justify-center">{year}</h4>
       <button onClick = {clickButton} className = "mb-3 text-3xl font-semibold tracking-tight text-white flex w-[100%] justify-center">+</button>
       {isActive ? 
