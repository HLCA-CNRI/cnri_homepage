...
export const WorkAndPartnershipContent:{ [key: string]: any  } = {
    totalBusiness:{
        ...
        img: <img id  = "totalBusiness" src = {totalBusiness.src}  className = "object-cover w-full " />,
        hasMultiple: false
    },
    ts:{
        title: "ts", 
        ...
        img: [<img id  = "ts" src = {ts1.src}  className = "object-cover w-full " />,<img id  = "ts" src = {ts2.src}  className = "object-cover w-full " />],
        hasMultiple: true
    }, 
    h2:{
        title: "h2", 
        ...
        img: <img id  = "ts" src = {h2.src}  className = "object-cover w-full " />,
        hasMultiple: false
    },
    posco:{
        title: "posco", 
        ...
        img: <img id  = "totalBusiness" src = {posco.src}  className = "object-cover w-full " />,
        hasMultiple: false
    },
    snu:{
        title: "snu", 
        ...
        img: <img id  = "totalBusiness" src = {snu.src}  className = "object-cover w-full " />,
        hasMultiple: false
    },
