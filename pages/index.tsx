  ...
  return (
    <div className = "overflow-hidden">
      ...
      <main>
        ...
        {/* REDUCE SECTION*/}
        <div id = "reduce" className=" mx-16 text-5xl">Reduce</div>
        <div className="mx-16 grid grid-cols-2 gap-14 my-4">
          <div>
            <HorizontalTransitionVideoInfo
              imagePosition="right"
        ...
        {/* REMOVE SECTION*/}
        <div id = "remove" className=" mx-16 text-5xl">Remove</div>
        <div className="mx-16">
          <HorizontalTransitionVideoInfo
            imagePosition="left"
            moveFrom={TansitionLToR}
        ...
        {/* REPORT SECTION*/}
        <div id = "report" className=" mx-16 text-5xl">Report</div>
        <div className="mx-16 grid grid-cols-2 gap-14 my-4">
          <VerticalTansitionVideoInfo
            imagePosition="top"
            moveFrom={TansitionLToR}
