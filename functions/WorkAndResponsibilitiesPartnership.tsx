const WorkAndPartnershipContent: {[key: string]: any} = {
  ...
  ts: {
    ...
    content: [
      ...
      [
        "국토교통부 BIG 3 과제 중 하나로 LCA 분과의 전문가 워킹그룹으로 참여했습니다.",
        "전기차 보급이 가속화되면서 자동차 온실가스의 환경성 평가 체계의 구조 수정이 중요해졌고 전기차의 에너지원인 전기와 내연기관차의 에너지원인 휘발유/경유/LPG/CNG 의 전과정 온실가스 배출량을 측정하고 기준 수치를 도출하여 규제화를 앞두고 있습니다",
      ],
    ],
    default: (
  ...
  h2: {
    ...
    img: <img alt="h2" id="ts" src="/images/partnershipData/h2.png" className=" h-full w-auto " />,
    hasMultiple: false,
  },
  posco: {
    title: "posco",
