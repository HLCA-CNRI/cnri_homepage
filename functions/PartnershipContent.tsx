const PartnershipContent: {[key: string]: any} = {
  totalBusiness: {
    ...
    default: {alt: "totalBusinessD", src: "/images/companies/totalBusinessD.png"},
    colored: {alt: "totalBusinessC", src: "/images/companies/totalBusinessC.png"},
    img: [{alt: "totalBusiness", src: "/images/partnershipData/totalBusiness.png"}],
    hasMultiple: false,
  },
  ts: {
    title: "ts",
    ...
    default: {alt: "ts", src: "/images/companies/tsD.png"},
    colored: {alt: "ts", src: "/images/companies/tsC.png"},
    img: [
      {alt: "ts", src: "/images/partnershipData/ts1.png"},
      {alt: "ts", src: "/images/partnershipData/ts2.png"},
    ],
    hasMultiple: true,
  },
  h2: {
    ...
    default: {alt: "h2D", src: "/images/companies/h2D.png"},
    colored: {alt: "h2C", src: "/images/companies/h2C.png"},
    img: [{alt: "h2", src: "/images/partnershipData/h2.png"}],
    hasMultiple: false,
  },
  posco: {
    title: "posco",
    ...
    default: {alt: "poscoD", src: "/images/companies/poscoD.png"},
    colored: {alt: "poscoC", src: "/images/companies/poscoC.png"},
    img: [{alt: "posco", src: "/images/partnershipData/posco.png"}],
    hasMultiple: false,
  },
  snu: {
    title: "snu",
    ...
    default: {alt: "snuD", src: "/images/companies/snuD.png"},
    colored: {alt: "snuC", src: "/images/companies/snuC.png"},
    img: [{alt: "snu", src: "/images/partnershipData/snu.png"}],
    hasMultiple: false,
  },
};
