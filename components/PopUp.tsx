        ...
        <MobliePopUp className="md:hidden landscape:hidden relative overflow-clip m-auto w-[77vw] h-[68vh] bg-popup-img-moblie bg-cover pt-[1.7vh]">
          ...
          <div className="static">
            ...
            <div className="block relative py-[0.5vh]">
              <span className="listContainer dummyList right-[72vw]">{PopUpContents.list[2]}</span>
              <span className="listContainer realList left-[9vw]">{PopUpContents.list[0]}</span>
              <span className="listContainer dummyList left-[68vw] ">{PopUpContents.list[1]}</span>
            </div>
            {/* 두번째줄 */}
            <div className="block relative top-[5vh] py-[0.5vh]">
              <span className="listContainer dummyList right-[63vw]">{PopUpContents.list[0]}</span>
            ...
            <div className="block relative top-[10vh] py-[0.5vh]">
              ...
              <span className="listContainer dummyList left-[66vw]  ">{PopUpContents.list[0]}</span>
            </div>
          </div>
