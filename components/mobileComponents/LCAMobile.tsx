...
const LCAMobile = () => {
  ...
  return (
    <div>
      ...
      <div id = "resources" className="border-2 flex justify-center py-[1vh] " onClick={userClick}>
        ...
        <div id = "processing" className="border-2 flex justify-center py-[1vh]"  onClick={userClick}>
        ...
        <div id = "manufacturing" className="border-2 flex justify-center py-[1vh] " onClick={userClick}>
        ...
        <div id = "distribution" className="border-2 flex justify-center py-[1vh] " onClick={userClick}>
        ...
        <div id = "use" className="border-2 flex justify-center py-[1vh] " onClick={userClick}>
        ...
        <div id = "endOfLife" className="border-2 flex justify-center py-[1vh] " onClick={userClick}>
      ...
      <div className = "mt-[2vh] border-4 p-[3vw]">
          <video ref = {videoRef} autoPlay muted loop src = {currentObj.videoPath}></video>
